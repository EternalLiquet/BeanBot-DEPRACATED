...
- **Apps → Delete Role Menu** on a published panel opens a private deletion confirmation for administrators.
- `/role-menu delete` opens a human-readable, paged selector for the same deletion flow.
