...
public class ReactionRoleSettingsTests
{
    [Fact]
    ...
    public void Constructor_CopiesRoleEmotePairs()
    {
        ...
        var settings = new ReactionRoleSettings(pairs, "guild", "channel", "message");
    ...
    public void Constructor_RejectsNullCollection()
    {
        Assert.Throws<ArgumentNullException>(
            () => new ReactionRoleSettings(null!, "guild", "channel", "message"));
    }
    ...
    public void LegacyBson_DeserializesIntoModernProperties()
    {
        ...
        var settings = BsonSerializer.Deserialize<ReactionRoleSettings>(legacyDocument);
    ...
    {
        var settings = BsonSerializer.Deserialize<ReactionRoleSettings>(
