...
public class BoundedReactionRoleSettingsCacheTests
{
    [Fact]
    public void Set_EvictsLeastRecentlyUsedEntryAtCapacity()
    {
        var cache = new BoundedReactionRoleSettingsCache(2);
    ...
    public async Task ConcurrentSets_NeverExceedCapacityOrCorruptCache()
    {
        ...
        var cache = new BoundedReactionRoleSettingsCache(capacity);
