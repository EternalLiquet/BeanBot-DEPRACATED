...
public sealed class FortuneMessageEditHandler : IDisposable
{
    ...
    private readonly FortuneResponseEditService _fortuneResponseEditService;
    private readonly ILogger<FortuneMessageEditHandler> _logger;
    ...
    public FortuneMessageEditHandler(
        DiscordSocketClient discordClient,
        FortuneResponseEditService fortuneResponseEditService,
        ILogger<FortuneMessageEditHandler> logger)
    {
        _discordClient = discordClient ?? throw new ArgumentNullException(nameof(discordClient));
        _fortuneResponseEditService = fortuneResponseEditService ?? throw new ArgumentNullException(nameof(fortuneResponseEditService));
    ...
    {
        _ = TryTrackOperation(
            token => _fortuneResponseEditService.HandleUpdate(
                oldMessage,
                newMessage,
                messageChannel,
                token,
