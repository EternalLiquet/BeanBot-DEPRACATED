...
namespace BeanBot.Discord.Fortunes;

public sealed class FortuneResponseEditService
{
    ...
    private readonly ILogger<FortuneResponseEditService> _logger;

    public FortuneResponseEditService(
        DiscordSocketClient discordClient,
        ILogger<FortuneResponseEditService> logger)
    {
